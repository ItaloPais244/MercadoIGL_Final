...
namespace MercadoIGL.Controllers
{
    ...
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idFuncionario,cpf,nome,cargo")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idFuncionario,cpf,nome,cargo")] Funcionario funcionario)
        {
